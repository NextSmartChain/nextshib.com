<template>
  <div class="bg-black text-white">
    ...
    <Toptext v-show="!is_paused" class="hidden"/>

    <div class="relative py-4">
      <!-- Further alerts from the platform -->
      <transition name="fade">
        <div
            class="z-50 mx-6 fixed inset-x-0 top-0 m-auto flex items-center bg-yellow-500 text-yellow-800 text-md px-4 py-4 lg:w-6/6 rounded-b-md"
      ...
      <div class="text-right px-2 sm:px-6 space-x-4 flex justify-end">
        <a type="button"
                class="whitespace-nowrap inline-flex items-center px-3 py-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-md text-gray-200 bg-gray-900 hover:bg-gray-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 "
                id="menu-button" aria-expanded="false" aria-haspopup="true"
                href="https://social.nextshib.com">
                Social Network
                <svg xmlns="http://www.w3.org/2000/svg" class="ml-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
        </svg>
        </a>
        ...
        <div class="relative inline-block text-left">
          <div>
            ...
            <button type="button"
              ...
              <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5  ml-2 -mr-1" viewBox="0 0 20 20"
                   fill="currentColor">
                <path fill-rule="evenodd"
          ...
          <div v-show="dropdownShow"
               class="origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-black bg-opacity-20 ring-1 ring-black ring-opacity-5 focus:outline-none"
               role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1"
          >
            <div class="py-0.5" role="none">
              <button type="button"
                      v-if="networkId != 1"
                      class="whitespace-nowrap inline-flex items-center px-3 py-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-md text-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      id="menu-button" aria-expanded="false" aria-haspopup="true"
              ...
              <button type="button"
                      v-if="networkId != 56"
                      class="w-44 whitespace-nowrap inline-flex items-center px-3 py-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-md text-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      id="menu-button" aria-expanded="false" aria-haspopup="true"
              ...
              <button type="button"
                      v-if="networkId != 96"
                      class="w-44 whitespace-nowrap inline-flex items-center px-3 py-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-md text-blue-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      id="menu-button" aria-expanded="false" aria-haspopup="true"
              ...
              <button type="button"
                      v-if="networkId != 137"
                      class="w-44 whitespace-nowrap inline-flex items-center px-3 py-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-md text-purple-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      id="menu-button" aria-expanded="false" aria-haspopup="true"
        ...
        <!-- <button class="btn btn-primary" id="btn-connect" @click="connect">
          Connect wallet
        </button> -->
      </div>
    </div>
    ...
    <section class="py-20 bg-gray-800">
      <div class="container px-4 mx-auto">
        <h2 class="mb-12 text-center text-xl font-bold font-heading text-white">As featured on</h2>
        <div class="flex flex-wrap -m-4">
          <div class="w-full md:w-1/2 lg:w-1/5 p-4">
            <div class="flex w-full h-32 items-center justify-center border-2 border-gray-600 rounded-lg">
              <a href="https://ambcrypto.com/next-shib-next-generation-meme-token-about-to-go-public/" target="_blank"><img class="h-4" src="../assets/img/logo/ambcrypto.svg" alt="AMB Crypto"></a>
            </div>
          </div>
          <div class="w-full md:w-1/2 lg:w-1/5 p-4">
            <div class="flex w-full h-32 items-center justify-center border-2 border-gray-600 rounded-lg">
              <a href="https://beincrypto.com/next-shib-the-next-gen-meme-token-is-about-to-go-public/" target="_blank"><img class="h-6 fill-current" src="../assets/img/logo/beincrypto.svg" alt="BeInCrypto"></a>
            </div>
          </div>
          <div class="w-full md:w-1/2 lg:w-1/5 p-4">
            <div class="flex w-full h-32 items-center justify-center border-2 border-gray-600 rounded-lg">
              <a href="https://www.coinspeaker.com/next-generation-meme-token-next-shib-go-public/" target="_blank"><img class="h-32" src="../assets/img/logo/coinspeaker.svg" alt="Coinspeaker"></a>
            </div>
          </div>
          <div class="w-full md:w-1/2 lg:w-1/5 p-4">
            <div class="flex w-full h-32 items-center justify-center border-2 border-gray-600 rounded-lg">
              <a href="https://www.investing.com/news/cryptocurrency-news/next-shib-next-generation-meme-token-about-to-go-public-2740877" target="_blank"><img class="h-24 " src="../assets/img/logo/investing.com.svg" alt="Investing.com"></a>
            </div>
          </div>
          <div class="w-full md:w-1/2 lg:w-1/5 p-4">
            <div class="flex w-full h-32 items-center justify-center border-2 border-gray-600 rounded-lg">
              <a href="https://news.yahoo.com/news/nextshib-launched-decentralized-social-network-193000876.html" target="_blank"><img class="h-20" src="../assets/img/logo/yahoo-finance.svg" alt="Yahoo Finance"></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <a id="tokensale"/>
    <div class="hidden text-3xl text-center w-full items-center justify-center pt-12 text-black">
      <!--        Round <b>1</b> (<b>{{Math.round(this.price*1000)/1000}} NEXTSHIB / {{this.curCoin.sym}}</b>)-->
      <!--        <br/>-->
      <!--        <br/>-->
      <p class="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-yellow-300 to-yellow-600 pb-8 uppercase hidden">
        Tokensale is live!</p>
    </div>

    <!-- PROGRESS BAR -->
    <ProgressBar v-show="!is_paused" :sold-amount="soldAmount" :sold-percentage="soldPercent"/>

    <!-- <Countdown /> -->
    <section class="bg-gradient-to-t from-gray-700 to-grey-600 py-12 lg:px-10 mx-4 hidden" v-show="!is_paused">
      <div v-if="!this.ethereum">
        <div class="max-w-6xl mx-auto" x-data="{ qr: false }">
          <label class="block font-medium text-white font-bold text-4xl text-center">Send ETH or BNB to The Address
            Below</label>
      ...
      <!-- DURING SALE -->
      <div v-else-if="!is_paused&&(networkId==1||networkId==56||networkId==137)"
           class="m-auto d-flex w-full bg-gray-900 py-6 px-4 rounded .shadow-2xl">
        <!-- NO CLAIM -->
        <div v-if="claimableAmount == 0">
          ...
          <div class="mt-2 flex flex-row items-center justify-between mb-6 px-6">
            <input
                class="bg-gray-900 appearance-none font-medium text-2xl py-1 rounded w-full  mb-3 leading-tight focus:outline-none focus:shadow-outline"
                type="text" placeholder="0.0" v-model="sendAmount">
          ...
          <div class="mt-2 flex flex-row items-center justify-between mb-6 px-6">
            <input
                class="bg-gray-900 appearance-none font-medium text-2xl py-1 rounded w-full mb-3 leading-tight focus:outline-none focus:shadow-outline"
                type="text" placeholder="0.0" v-model="recvAmount">
      ...
      <div v-else-if="is_paused&&(networkId==1||networkId==56||networkId==137)&&claimableAmount>0"
        ...
        <div class="mt-2 flex flex-row items-center justify-between mb-6 px-6 text-black">
          <input
              class="bg-transparent appearance-none font-medium text-2xl py-1 w-full mb-3 leading-tight focus:outline-none focus:shadow-outline"
              type="text" placeholder="0" v-model="claimableAmount" disabled>
          <label class="ml-2 font-semibold text-xl">NEXTSHIB</label>
        </div>
        <button
      ...
      <div v-else v-show="!is_paused" class="m-auto d-flex w-full bg-gray-800 p-4 rounded .shadow-2xl">
    ...
    <Stats :burn-amount="nextBurned" :total-supply="inCirculation" :price-usd="priceUsd" :network-id="networkId"/>
